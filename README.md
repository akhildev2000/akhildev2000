...
I'm a Flutter engineer with **3.6+ years** shipping cross-platform apps at enterprise scale.
Currently building the **Chennai Metro Rail** mobile app and **Studiomart** at Vaanam
Technologies — end-to-end product ownership, from architecture to release.

What sets my workflow apart: I actively build with **agentic AI tooling** — Claude Code, MCP,
structured prompting — as a core part of how I ship, not a novelty. I've trained fellow
engineers at Vaanam on adopting the same practices.

- 🔭 Currently leading Flutter development on **Studiomart** & the **Chennai Metro Rail** enterprise app
- 🤖 Deep into **Agentic AI workflows** — Claude Code, MCP, Vibe Coding, prompt engineering for SDLC
- 🌱 Sharpening state management across **BLoC, Riverpod, and GetX**
- 🎓 NASSCOM-certified in **Agentic AI & AI-Assisted SDLC** (AI-Code Sarathi)
...
<img src="https://img.shields.io/badge/Agentic_AI_Workflows-1a1a2e?style=flat-square" />
...
**🚇 Chennai Metro Rail — Enterprise Mobile App** *(Vaanam Technologies, client project)*
Led mobile development as Senior across cross-functional teams for an app serving 2,000+ daily
users. Built Automated Breakdown Ticketing (cut manual escalation time 40%) and Voice-to-Text
accessibility, accelerating feature delivery by 20%.

**🛠️ CMMS — Comprehensive Maintenance Management System** *(Vaanam Technologies)*
Led the team on a large-scale maintenance app supporting 2,000+ daily users across 8+ internal
departments. Flutter + Riverpod frontend integrated with a .NET backend over REST APIs.

**🛍️ Studiomart** *(Vaanam Technologies)*
Converted a legacy web platform into a modern Flutter + GetX app with Clean Architecture,
deployed across iOS, Android, and Flutter Web. Integrated a JWT-secured microservices backend,
Firebase, Google Drive API, and Google Business API.

**📺 [Netflix UI Clone — BLoC Architecture](https://github.com/akhildev2000/netflix-ui)**
Pixel-accurate Netflix UI rebuilt with Flutter + BLoC/Cubit, `get_it` dependency injection, and
stream-based reactive state — built to practice production-grade state management patterns.
...
- **NASSCOM AI-Code Sarathi** — Agentic AI & AI-Assisted SDLC (Certified)
